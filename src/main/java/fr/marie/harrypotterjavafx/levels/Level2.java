...
public class Level2 {
    ...
    public void start(Wizard wizard) {
        ...
        if (isGryffindor) {
            ...
            WindowTalk.printInWindow("During this level, you can call on The legendary sword of Godric Gryffindor to defeat the basilisk.");
            ...
            WindowTalk.printInWindow("You'll have to rip one of his fangs out and use it to destroy Tom Riddle's journal");
        }
        ...
        if (wizard.getLife() <= 0) {
            ...
            WindowTalk.printInWindow("The BASILISK has defeated you! Game-over. ☠️");
        ...
        if (enemy.getLife() <= 0) {
            ...
            WindowTalk.printInWindow("Congratulations, you have defeated the basilisk! 🎇 \nYou can now access the next level.");
            wizard.setLife(100);
